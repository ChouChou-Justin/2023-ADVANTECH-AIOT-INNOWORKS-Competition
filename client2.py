...
def __generateConfig():
    config = EdgeConfig()
    deviceConfig = DeviceConfig(id='RaspberryPi2',
                                name='RaspberryPi2',
                                description='RaspberryPi2',
    ...
    for epoch in tqdm(range(epochs)):
        ...
        for i in range(len(X_train)):
            ...
            if (y_pred > 0.5):
                ...
                data.tagList.append(EdgeTag(deviceId='RaspberryPi2', tagName='Alarm', value=1))
                ...
                data.tagList.append(EdgeTag(deviceId='RaspberryPi2', tagName='Alarm', value=0))
                # Use the EdgeAgent instance to send this data to the cloud platform
                _edgeAgent.sendData(data)
            ...
            torch.save(gradients, 'gradients2.pth')
            ...
            data = EdgeData()
            # Add a single tag to this data object, setting the value to 1
            data.tagList.append(EdgeTag(deviceId='RaspberryPi2', tagName='SendGradientToMidServer', value=0))
            # Use the EdgeAgent instance to send this data to the cloud platform
            _edgeAgent.sendData(data)
            ...
            try:
                ...
                size = os.path.getsize('gradients2.pth')
                ...
                # Send the file
                with open('gradients2.pth', 'rb') as f:
                    for _ in range(size):
                ...
                data = EdgeData()
                # Add a single tag to this data object, setting the value to 1
                data.tagList.append(EdgeTag(deviceId='RaspberryPi2', tagName='SendGradientToMidServer', value=1))
                # Use the EdgeAgent instance to send this data to the cloud platform
                _edgeAgent.sendData(data)
